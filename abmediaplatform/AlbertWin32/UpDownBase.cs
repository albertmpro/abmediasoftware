...
namespace Albert.Win32
{
    ...
    public abstract class UpDownBase<T>: InputControlBase, IValidateInput
    {
...
#pragma warning restore 618
    ...
    UpDownBase<T>), new UIPropertyMetadata(true));
      ...
      true);
        ...
        public event InputErrorEventHandler InputValidationError;
    ...
    RoutedPropertyChangedEventHandler<object>), typeof(UpDownBase<T>));
        ...
        private void RaiseInputValidationError(Exception e)
        {
            ...
            {
                InputErrorEventArgs args = new InputErrorEventArgs(e);
